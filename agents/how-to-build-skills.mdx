...
For the short definitions of skill and agent, see [Core Concepts](/getting-started/core-concepts). For how agents run, see [Understanding Agents](/agents/understanding-agents).
...
Cora captures the instructions from your conversation and saves them as a new skill. Skills you create this way are **Restricted** by default, so only you can see and use them until you decide to share.
...
- **Restricted:** Only you can see and use the skill. This is the default for skills you create.
- **Org:** Everyone in your organization can use the skill.

To make a restricted skill available to your whole organization, select **Share** from its row on the **Skills** page.
...
- **Share what works.** When a restricted skill proves useful, set its visibility to Org so the rest of your team can use it too.