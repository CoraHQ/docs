...
**Artifact.** A saved deliverable on an account or the workspace: a document, dashboard, presentation, survey, checklist, file, or link. Agents and chat create them. You open them on the **Artifacts** page. See [Artifacts](/using-cora/artifacts).
...
**Artifacts** are the saved outputs from agents and skills: documents, dashboards, presentations, surveys, and similar deliverables. They live on the **Artifacts** page. The run is the execution; the artifact is what you keep. Chat or Slack can run a skill, start an agent, or write an artifact.
