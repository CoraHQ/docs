...
## Restricted vs. Organization

By default, an MCP server you connect is **restricted** — only you can use it in chat and only your agents can access it.

If you want your whole team to have access, click the **share icon** on the entry, then switch visibility from **Restricted** to **Everyone in organization** in the dropdown.

Only the person who created the connection can change this setting. Visibility applies to both chat and agents: restricted connections are only available to the creator, while organization-wide connections are available to everyone.
