...
## Private vs. Organization

By default, an MCP server you connect is **private** — only you can use it in chat and only your agents can access it.

If you want your whole team to have access, click the **share icon** on the entry, then switch visibility from **Private** to **Everyone in organization** in the dropdown.
